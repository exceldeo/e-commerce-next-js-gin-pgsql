...
const (
	...
	InvalidBuyOwnProducts          = "Invalid Buy Own Products."
)
...
func returnJSONResponse(w http.ResponseWriter, isSuccess bool , message string, data interface{}, statusCode int) {
...
func SuccessResponse(w http.ResponseWriter, data interface{}, statusCode ...int) {
	...
	returnJSONResponse(w, true, "", data, code)
}
...
func ErrorResponse(w http.ResponseWriter, message string, statusCode ...int) {
	...
	returnJSONResponse(w, false, message, nil, code)
}
...
func ErrorResponseData(w http.ResponseWriter, data interface{}, message string, statusCode ...int) {
	...
	returnJSONResponse(w, false, message, data, code)
}

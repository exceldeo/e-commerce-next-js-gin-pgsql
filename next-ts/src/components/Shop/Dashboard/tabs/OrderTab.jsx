...
import { useGetAllOrders, useUpdateOrder } from '../../../../api/seller/order';
...
export default function OrderTab() {
  ...
  const handleUpdateOrder = (item, status) => {
    item.status = status;
                  ...
                  <tr key={i} className='border-b bg-white hover:bg-gray-50'>
                    ...
                    <td className='flex justify-center py-4'>
                      <div className='flex items-center space-x-2 rtl:space-x-reverse'>
                        {item.status === 1 && (
                          <button onClick={() => handleUpdateOrder(item, 3)}>
                        ...
                        {item.status === 1 && (
                          <button onClick={() => handleUpdateOrder(item, 2)}>
                            <div className='flex h-[46px] w-[116px] cursor-pointer items-center justify-center bg-red-400 font-bold text-white'>
                              <span>Reject</span>
                            </div>
                          </button>
                        )}

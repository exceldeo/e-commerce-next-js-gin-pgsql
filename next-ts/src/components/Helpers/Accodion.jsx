...
export default function Accodion({ init, title, des }) {
  ...
  return (
    <div
      className={`accordion-item w-full overflow-hidden bg-white ${
    ...
    >
      <button
        onClick={handler}
        type='button'
        className='flex h-[60px] w-full items-center justify-between px-5 text-qblack'
      >
        <span className='text-start text-sm font-semibold capitalize sm:text-base'>
          {title}
        </span>
      ...
      {collaps && (
        <div className='border-t border-[#E5A832] p-5'>

...
export default function Drawer({ className, open, action }) {
  ...
  return (
    <>
      <div
        className={`drawer-wrapper relative block h-full w-full lg:hidden  ${
          className || ''
        }`}
      >
        {open && (
          ...
          <div className='mt-5 w-full px-5'>
            <div className='search-bar flex h-[34px]  w-full '>
              ...
              <div
                ...
                className='flex h-full w-[40px] cursor-pointer items-center justify-center bg-qyellow'
              >
                <span>
                  <svg
                    width='23'
              ...
              {categoryList &&
                categoryList.map((item, i) => (
                  <li key={i} className='category-item'>
                    ...
                    >
                      <div className=' flex h-12 cursor-pointer items-center justify-between bg-white px-5 transition-all duration-300 ease-in-out hover:bg-qyellow'>

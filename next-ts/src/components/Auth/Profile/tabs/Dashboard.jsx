    ...
    <>
      <div className='welcome-msg w-full'>
        <div>
          ...
          <h1 className='text-[24px] font-bold text-qblack'>
            {ServeLangItem()?.Welcome_to_your_Profile}
          </h1>
        </div>
      </div>
      <div className='quick-view-grid mt-3 w-full items-center justify-between lg:flex lg:space-x-2 xl:space-x-0 '>
        <div className='qv-item group mb-5 w-full bg-qblack p-6 transition-all duration-300 ease-in-out hover:bg-qyellow lg:w-1/2 xl:mb-0 xl:h-[208px] xl:w-[252px]'>
          ...
          <span className='mt-1 block text-[40px] font-bold leading-none text-white group-hover:text-qblacktext'>
      ...
      <div className='dashboard-info mt-8 mb-8 items-center justify-between bg-primarygray p-3 xl:flex xl:p-7'>
        <div className='mb-10 xl:mb-0'>
          ...
          <div className='mt-5'>
            <table>
              <tbody>
                <tr className='mb-5 flex'>
                  <td className='block w-[100px] text-base capitalize text-qgraytwo'>
      ...
      {/*account delete*/}
      <div className=' border-[rgba(0, 0, 0, 0.1)] border px-7 py-7 '>
        <h2 className='mb-1 text-2xl font-bold text-[#cf222e]'>
          {ServeLangItem()?.Delete_Account}
        </h2>
        <p className='mb-5 text-base text-qgray'>
          {
            ServeLangItem()
        ...
        {/* <button
          ...
          type='button'
          className='border-[rgba(0, 0, 0, 0.1)] border bg-[#f6f8fa] py-[5px] px-[16px] text-sm font-semibold tracking-wide text-[#cf222e] transition duration-300 ease-in-out hover:border-[#cf222e] hover:bg-[#cf222e] hover:text-white'
        >
          {ServeLangItem()?.Delete_Account}
        </button> */}
      </div>
      {/* {confirmation && (
        <div className='fixed left-0 top-0 z-40 flex h-screen w-full items-center justify-center'>
          <div
            onClick={confirmHandler}
            className='fixed left-0 top-0 h-full w-full bg-black bg-opacity-50'
          ></div>
          <div
            className={`z-50 flex w-[400px] transform items-center justify-center bg-white p-7 transition duration-300 ease-in-out ${
          ...
          >
            <div>
              ...
              <div className='mb-7 flex justify-center'>
                <div>
                  <h2 className='mb-5 text-center text-2xl font-medium text-gray-700'>
                    {ServeLangItem()?.Are_You_Sure}
                  </h2>
                  <p className='px-2 text-center text-sm leading-[24px] text-qgraytwo'>
                    {
                      ServeLangItem()
              ...
              <div className='mb-5'>
                <p className='text-sm leading-[24px] text-qgraytwo'>
                  Enter the email{' '}
                ...
                <input
                  className='input-field text-dark-gray h-[50px] h-full w-full border border-qgray-border bg-white px-6 text-sm font-normal placeholder:text-sm focus:outline-none focus:ring-0'
                  type='text'
                  value={confirmUser}
              ...
              <div className='flex justify-center'>
                <div className='flex items-center space-x-5'>
                  <button
                    onClick={confirmHandler}
                    type='button'
                    className='text-base font-semibold capitalize text-qgraytwo'
                  >
                  ...
                  <button
                    ...
                    onClick={deleteUser}
                    type='button'
                    className='bg-[#cf222e] py-[10px] px-[26px] text-base  font-semibold tracking-wide text-white transition duration-300 ease-in-out disabled:cursor-not-allowed disabled:bg-opacity-50'
                  >
